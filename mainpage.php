    ...
    <div class = "Main">
        ...
        <div class = "stories">
            <?php
                ...
                $resbind = $stmt->bind_result($userstoriesid, $userstoriestitle, $userstoriesbody, $userstorieslink);
                if(!($resbind))
                {
                ...
                while($stmt->fetch())
                {
                        ...
                        if($userstorieslink != null)
                        {
                            printf("Link: %s <br />", htmlspecialchars($userstorieslink));
                        }
                        printf("<br />");
                }
